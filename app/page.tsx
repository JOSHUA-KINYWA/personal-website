        ...
        <div className="container-custom relative z-10 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-block mb-6 px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-sm font-medium">
                👋 Welcome! I'm Available for Hire
              </div>
              ...
              <p className="text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed">
                ...
                <br />
                <span className="text-lg text-slate-400">Building intelligent solutions that transform data into actionable insights</span>
              </p>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
                <a 
                  href="#contact"
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl transition-all duration-300 font-semibold shadow-2xl hover:shadow-blue-500/50 transform hover:-translate-y-1 text-lg"
                >
                  Hire Me
                </a>
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-8 py-4 bg-green-500 hover:bg-green-600 text-white rounded-xl transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center gap-2 text-lg"
                >
      ...
      <section id="experience" className="section-padding bg-gradient-to-br from-slate-50 to-blue-50/20">
        <div className="container-custom">
          ...
          <div className="space-y-6">
            {/* Software Engineer */}
            <div className="bg-white rounded-2xl p-8 card-hover border border-slate-200 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
                <div>
                  ...
                  <p className="text-blue-600 font-semibold mb-1 text-lg">
                    Softwarse Tutors | Softhub Technologies
                  </p>
              ...
              <ul className="space-y-3 text-slate-600 list-none">
                <li className="flex items-start gap-3">
                  ...
                  <span>Guided clients in software development, data science, and analytics projects</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Provided training on programming, data cleaning, visualization, and machine learning</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Supported clients in solving technical challenges and tailored solutions to meet project needs</span>
                </li>
              </ul>
            </div>
      ...
      <section id="education" className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100 card-hover shadow-sm">
              <div className="mb-4">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 border border-indigo-100 card-hover shadow-sm">
              <div className="mb-4">
      ...
      <section id="contact" className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-8 border border-slate-200 shadow-sm card-hover">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">
                Eng. Kelvin Mayaka
              </h3>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-purple-50 rounded-2xl p-8 border border-slate-200 shadow-sm card-hover">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">
